...
public class ChargingSchedulePeriod extends TableImpl<ChargingSchedulePeriodRecord> {
     ...
     */
    public final TableField<ChargingSchedulePeriodRecord, BigDecimal> POWER_LIMIT = createField(DSL.name("power_limit"), SQLDataType.NUMERIC(15, 1).nullable(false), this, "");
    ...
    public List<UniqueKey<ChargingSchedulePeriodRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UQ_CHARGING_SCHEDULE_PERIOD);
    }

    @Override
    public List<ForeignKey<ChargingSchedulePeriodRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CHARGING_SCHEDULE_PERIOD__FK_CHARGING_SCHEDULE_PERIOD_CHARGING_PROFILE_PK);
    }
    ...
    public ChargingProfile chargingProfile() {
        if (_chargingProfile == null)
            _chargingProfile = new ChargingProfile(this, Keys.CHARGING_SCHEDULE_PERIOD__FK_CHARGING_SCHEDULE_PERIOD_CHARGING_PROFILE_PK);
