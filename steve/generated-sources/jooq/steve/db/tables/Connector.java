...
public class Connector extends TableImpl<ConnectorRecord> {
    ...
    public UniqueKey<ConnectorRecord> getPrimaryKey() {
        return Keys.CONNECTOR_PKEY;
    }

    @Override
    public List<UniqueKey<ConnectorRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.CONNECTOR_CHARGEBOXID_CONNECTORID_KEY);
    }

    @Override
    public List<ForeignKey<ConnectorRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONNECTOR__FK_CONNECTOR_CHARGE_BOX_CBID);
    }
    ...
    public ChargeBox chargeBox() {
        if (_chargeBox == null)
            _chargeBox = new ChargeBox(this, Keys.CONNECTOR__FK_CONNECTOR_CHARGE_BOX_CBID);
