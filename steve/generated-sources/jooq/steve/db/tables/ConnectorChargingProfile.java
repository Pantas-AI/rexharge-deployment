...
public class ConnectorChargingProfile extends TableImpl<ConnectorChargingProfileRecord> {
    ...
    public List<UniqueKey<ConnectorChargingProfileRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UQ_CONNECTOR_CHARGING_PROFILE);
    }

    @Override
    public List<ForeignKey<ConnectorChargingProfileRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONNECTOR_CHARGING_PROFILE__FK_CONNECTOR_CHARGING_PROFILE_CONNECTOR_PK, Keys.CONNECTOR_CHARGING_PROFILE__FK_CONNECTOR_CHARGING_PROFILE_CHARGING_PROFILE_PK);
    }
    ...
    public Connector connector() {
        if (_connector == null)
            _connector = new Connector(this, Keys.CONNECTOR_CHARGING_PROFILE__FK_CONNECTOR_CHARGING_PROFILE_CONNECTOR_PK);
    ...
    public ChargingProfile chargingProfile() {
        if (_chargingProfile == null)
            _chargingProfile = new ChargingProfile(this, Keys.CONNECTOR_CHARGING_PROFILE__FK_CONNECTOR_CHARGING_PROFILE_CHARGING_PROFILE_PK);
