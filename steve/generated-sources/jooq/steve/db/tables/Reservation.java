...
public class Reservation extends TableImpl<ReservationRecord> {
     ...
     */
    public final TableField<ReservationRecord, DateTime> START_DATETIME = createField(DSL.name("start_datetime"), SQLDataType.TIMESTAMP(6), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.reservation.expiry_datetime</code>.
     */
    public final TableField<ReservationRecord, DateTime> EXPIRY_DATETIME = createField(DSL.name("expiry_datetime"), SQLDataType.TIMESTAMP(6), this, "", new DateTimeConverter());
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.FK_CONNECTOR_PK_RESERV_IDX, Indexes.RESERVATION_EXPIRY_IDX, Indexes.RESERVATION_START_IDX, Indexes.RESERVATION_STATUS_IDX, Indexes.TRANSACTION_PK_UNIQUE);
    }
    ...
    public List<ForeignKey<ReservationRecord, ?>> getReferences() {
        return Arrays.asList(Keys.RESERVATION__FK_RESERVATION_OCPP_TAG_ID_TAG, Keys.RESERVATION__FK_TRANSACTION_PK_R, Keys.RESERVATION__FK_CONNECTOR_PK_RESERV);
    }
    ...
    public OcppTag ocppTag() {
        if (_ocppTag == null)
            _ocppTag = new OcppTag(this, Keys.RESERVATION__FK_RESERVATION_OCPP_TAG_ID_TAG);
    ...
    public TransactionStart transactionStart() {
        if (_transactionStart == null)
            _transactionStart = new TransactionStart(this, Keys.RESERVATION__FK_TRANSACTION_PK_R);
    ...
    public Connector connector() {
        if (_connector == null)
            _connector = new Connector(this, Keys.RESERVATION__FK_CONNECTOR_PK_RESERV);
