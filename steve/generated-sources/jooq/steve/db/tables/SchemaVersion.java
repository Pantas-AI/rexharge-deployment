...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
     ...
     */
    public final TableField<SchemaVersionRecord, DateTime> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.TIMESTAMP(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.SCHEMA_VERSION_S_IDX);
    }
