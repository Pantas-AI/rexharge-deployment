...
public class Settings extends TableImpl<SettingsRecord> {
     ...
     */
    public final TableField<SettingsRecord, Boolean> MAIL_ENABLED = createField(DSL.name("mail_enabled"), SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>stevedb.settings.mail_host</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_HOST = createField(DSL.name("mail_host"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_username</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_USERNAME = createField(DSL.name("mail_username"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_password</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_PASSWORD = createField(DSL.name("mail_password"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_from</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_FROM = createField(DSL.name("mail_from"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_protocol</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_PROTOCOL = createField(DSL.name("mail_protocol"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("'smtp'::character varying", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.settings.mail_port</code>.
     */
    public final TableField<SettingsRecord, Integer> MAIL_PORT = createField(DSL.name("mail_port"), SQLDataType.INTEGER.defaultValue(DSL.field("25", SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>stevedb.settings.mail_recipients</code>.
     */
    public final TableField<SettingsRecord, String> MAIL_RECIPIENTS = createField(DSL.name("mail_recipients"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>stevedb.settings.notification_features</code>.
     */
    public final TableField<SettingsRecord, String> NOTIFICATION_FEATURES = createField(DSL.name("notification_features"), SQLDataType.CLOB, this, "");
