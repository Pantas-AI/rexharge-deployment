...
public class TransactionStart extends TableImpl<TransactionStartRecord> {
     ...
     */
    public final TableField<TransactionStartRecord, DateTime> START_TIMESTAMP = createField(DSL.name("start_timestamp"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field("NULL::timestamp without time zone", SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());

    /**
     * The column <code>stevedb.transaction_start.start_value</code>.
     */
    public final TableField<TransactionStartRecord, String> START_VALUE = createField(DSL.name("start_value"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>stevedb.transaction_start.event_timestamp</code>.
     */
    public final TableField<TransactionStartRecord, DateTime> EVENT_TIMESTAMP = createField(DSL.name("event_timestamp"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field("CURRENT_TIMESTAMP(6)", SQLDataType.TIMESTAMP)), this, "", new DateTimeConverter());
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.TRANSACTION_START_IDX);
    }
    ...
    public List<ForeignKey<TransactionStartRecord, ?>> getReferences() {
        return Arrays.asList(Keys.TRANSACTION_START__FK_CONNECTOR_PK_T, Keys.TRANSACTION_START__FK_TRANSACTION_OCPP_TAG_ID_TAG);
    }
    ...
    public Connector connector() {
        if (_connector == null)
            _connector = new Connector(this, Keys.TRANSACTION_START__FK_CONNECTOR_PK_T);
    ...
    public OcppTag ocppTag() {
        if (_ocppTag == null)
            _ocppTag = new OcppTag(this, Keys.TRANSACTION_START__FK_TRANSACTION_OCPP_TAG_ID_TAG);
