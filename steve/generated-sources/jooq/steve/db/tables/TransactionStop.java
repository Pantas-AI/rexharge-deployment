...
public class TransactionStop extends TableImpl<TransactionStopRecord> {
     ...
     */
    public final TableField<TransactionStopRecord, Integer> TRANSACTION_PK = createField(DSL.name("transaction_pk"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<TransactionStopRecord, EventActor> EVENT_ACTOR = createField(DSL.name("event_actor"), SQLDataType.VARCHAR.asEnumDataType(jooq.steve.db.enums.EventActor.class), this, "");
    ...
    @Override
    public Identity<TransactionStopRecord, Integer> getIdentity() {
        return (Identity<TransactionStopRecord, Integer>) super.getIdentity();
    }

    @Override
    public UniqueKey<TransactionStopRecord> getPrimaryKey() {
        return Keys.TRANSACTION_STOP_PKEY;
    }

    @Override
    public List<ForeignKey<TransactionStopRecord, ?>> getReferences() {
        return Arrays.asList(Keys.TRANSACTION_STOP__FK_TRANSACTION_STOP_TRANSACTION_PK);
    }
    ...
    public TransactionStart transactionStart() {
        if (_transactionStart == null)
            _transactionStart = new TransactionStart(this, Keys.TRANSACTION_STOP__FK_TRANSACTION_STOP_TRANSACTION_PK);
