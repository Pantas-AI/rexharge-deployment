...
public class TransactionStopFailed extends TableImpl<TransactionStopFailedRecord> {
     ...
     */
    public final TableField<TransactionStopFailedRecord, EventActor> EVENT_ACTOR = createField(DSL.name("event_actor"), SQLDataType.VARCHAR.asEnumDataType(jooq.steve.db.enums.EventActor.class), this, "");
