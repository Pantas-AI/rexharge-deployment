...
public class TransactionRecord extends TableRecordImpl<TransactionRecord> implements Record11<Integer, Integer, String, DateTime, DateTime, String, EventActor, DateTime, DateTime, String, String> {
     ...
     */
    public TransactionRecord setStopEventActor(EventActor value) {
        set(6, value);
        return this;
    }
     ...
     */
    public EventActor getStopEventActor() {
        return (EventActor) get(6);
    }
    ...
    @Override
    public Row11<Integer, Integer, String, DateTime, DateTime, String, EventActor, DateTime, DateTime, String, String> valuesRow() {
    ...
    @Override
    public Field<EventActor> field7() {
    ...
    @Override
    public TransactionRecord value7(EventActor value) {
    ...
    @Override
    public TransactionRecord values(Integer value1, Integer value2, String value3, DateTime value4, DateTime value5, String value6, EventActor value7, DateTime value8, DateTime value9, String value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransactionRecord(Integer transactionPk, Integer connectorPk, String idTag, DateTime startEventTimestamp, DateTime startTimestamp, String startValue, EventActor stopEventActor, DateTime stopEventTimestamp, DateTime stopTimestamp, String stopValue, String stopReason) {
        super(Transaction.TRANSACTION);
