...
public class TransactionStopFailedRecord extends TableRecordImpl<TransactionStopFailedRecord> implements Record7<Integer, DateTime, EventActor, DateTime, String, String, String> {
     ...
     */
    public TransactionStopFailedRecord setEventActor(EventActor value) {
        set(2, value);
        return this;
    }
     ...
     */
    public EventActor getEventActor() {
        return (EventActor) get(2);
    }
    ...
    @Override
    public Row7<Integer, DateTime, EventActor, DateTime, String, String, String> fieldsRow() {
        return (Row7) super.fieldsRow();
    }

    @Override
    public Row7<Integer, DateTime, EventActor, DateTime, String, String, String> valuesRow() {
    ...
    @Override
    public Field<EventActor> field3() {
    ...
    @Override
    public TransactionStopFailedRecord value3(EventActor value) {
        setEventActor(value);
        return this;
    }
    ...
    @Override
    public TransactionStopFailedRecord values(Integer value1, DateTime value2, EventActor value3, DateTime value4, String value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransactionStopFailedRecord(Integer transactionPk, DateTime eventTimestamp, EventActor eventActor, DateTime stopTimestamp, String stopValue, String stopReason, String failReason) {
        super(TransactionStopFailed.TRANSACTION_STOP_FAILED);
