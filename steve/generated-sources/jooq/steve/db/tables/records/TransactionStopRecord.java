...
public class TransactionStopRecord extends UpdatableRecordImpl<TransactionStopRecord> implements Record6<Integer, DateTime, EventActor, DateTime, String, String> {
     ...
     */
    public TransactionStopRecord setEventActor(EventActor value) {
        set(2, value);
        return this;
    }
    ...
    @Override
    public Row6<Integer, DateTime, EventActor, DateTime, String, String> fieldsRow() {
        return (Row6) super.fieldsRow();
    }

    @Override
    public Row6<Integer, DateTime, EventActor, DateTime, String, String> valuesRow() {
    ...
    @Override
    public TransactionStopRecord value3(EventActor value) {
        setEventActor(value);
        return this;
    }
    ...
    @Override
    public TransactionStopRecord values(Integer value1, DateTime value2, EventActor value3, DateTime value4, String value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransactionStopRecord(Integer transactionPk, DateTime eventTimestamp, EventActor eventActor, DateTime stopTimestamp, String stopValue, String stopReason) {
        super(TransactionStop.TRANSACTION_STOP);
